...
jq -r '"Feels like: \(.currently.apparentTemperature | tostring) °C, Wind speed: \(.currently.windSpeed | tostring) m/s, Humidity: \(.currently.humidity * 100 | round | tostring)% | font=VictorMono-Bold"' "$FORECAST_FILE"
