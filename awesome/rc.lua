...
theme_path = "/home/sand/.config/awesome/piger.lua"
...
-- http://awesome.naquadah.org/wiki/Anrxcs_Widget_Set
...
mycpugraphwidget.width        = 40
mycpugraphwidget.height       = 0.90
mycpugraphwidget.grow         = "left"
mycpugraphwidget.bg           = '#333333'
mycpugraphwidget.border_color = '#0a0a0a'
...
function get_temp()
    local filedescriptor = io.popen('awk \'{print $2 "°C"}\' /proc/acpi/thermal_zone/THM0/temperature')
...
-- network load widget (troppo grande...)
netwidget = widget({
    type = 'textbox',
    name = 'netwidget'
})
...
wicked.register(netwidget, wicked.widgets.net, 
    ' <span color="white">NET</span>: ${eth1 down} / ${eth1 up} [ ${eth1 rx} //  ${eth1 tx} ]',
nil, nil, 3)
